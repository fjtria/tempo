...
export default function NutritionScreen() {
  ...
  useEffect(() => {
    if (editingReminderId) {
      const reminder = realm.objectForPrimaryKey('NutritionReminder', editingReminderId);
      if (reminder) {
  ...
  const handleSaveReminder = async () => {
    ...
    try {
      if (editingReminderId) {
        const reminderToUpdate = realm.objectForPrimaryKey('NutritionReminder', editingReminderId);
        ...
        realm.write(() => {
          realm.create('NutritionReminder', {
  ...
  const handleDelete = (reminder: NutritionReminder) => {
  ...
  const handleStartEdit = (reminder: NutritionReminder) => {
          ...
          <View key={reminder._id.toHexString()} style={styles.itemContainer}>
            ...
            <View style={styles.itemActions}>
              <TouchableOpacity onPress={() => handleStartEdit(reminder)}>
                <Ionicons name="pencil" size={24} color="#438669" />
              </TouchableOpacity>
